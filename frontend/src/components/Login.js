...
const Login = forwardRef(() => {
  ...
  const [isActive, setIsActive] = useState(false);
   ...
   const[user, setUser] = useState({
    first_name: "", last_name: "", phone: "", password: "", cpassword: ""
 });
      ...
      >
        ...
        <form action="/register" className="">
          ...
          <div className="input-box ">
            ...
            <input className="input" type="text" name="last_name" required 
          ...
          <div className="input-box">
            ...
            onChange={handleInput}
            />
            <label className="input-label input:focus~label">Confirm Password</label>
          </div>
          ...
          <button className="btn" type="submit" name="signup" value='register' onClick={PostData}>
            {" "}
            Register{" "}
          </button>
